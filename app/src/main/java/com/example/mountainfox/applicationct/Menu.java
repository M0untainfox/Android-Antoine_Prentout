...
public class Menu extends AppCompatActivity
    ...
    protected void onSaveInstanceState(Bundle outState) {
        outState.putParcelableArrayList("kk",ListeV);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            ListeV = savedInstanceState.getParcelableArrayList("kk");
        }
        ...
        ajouterListC(0,getBaseContext().getResources().getString(R.string.Car));
        ajouterListC(1,getBaseContext().getResources().getString(R.string.Camion) +" 3t5");
        ajouterListC(2,getBaseContext().getResources().getString(R.string.Moto));
        ajouterListC(3,getBaseContext().getResources().getString(R.string.Tracteur));
        ajouterListC(4,getBaseContext().getResources().getString(R.string.Camion));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_voiture) {
            ...
            */
            tb.setTitle(getBaseContext().getResources().getString(R.string.home));
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            ...
            fab.setVisibility(INVISIBLE);
            tb.setTitle(getBaseContext().getResources().getString(R.string.Info));
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            ...
            fab.setVisibility(INVISIBLE);
            tb.setTitle(getBaseContext().getResources().getString(R.string.add));
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
